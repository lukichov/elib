 ...
 * Project <b> elib</b>.
 *
 * This Entity Class describes Authors
 *
 * @version $version$
...
public class Author implements Serializable {
	...
	public String toString() {
		return "Author{" + "authorId=" + authorId + ", authorShortName=" + authorShortName + ", authorFirstName="
				+ authorFirstName + ", authorSecondName=" + authorSecondName + ", authorSurname=" + authorSurname
