 ...
 * Project <b> elib</b>.
 *
 * This Entity Class describes an AccessTypes of Books
 *
 * @version $version$
...
@NamedQueries({ @NamedQuery(name = "AccessType.findAll", query = "SELECT a FROM AccessType a"),
...
public class AccessType implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.accessTypeId == null && other.accessTypeId != null)
				|| (this.accessTypeId != null && !this.accessTypeId.equals(other.accessTypeId))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "AccessType{" + "accessTypeId=" + accessTypeId + ", accessTypeName=" + accessTypeName
